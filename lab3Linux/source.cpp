...
int createSemaphoreSet(key_t key)
{
    ...
    if (id != -1)
    {
        check = semctl(id, 0, SETALL,const_cast<short*>(kSetArray)); // SETALL ignores
...
int main()
{
    ...
    case 0:
    {
        while(true)
        {
            ...
            cout << "Client: " << (char*)shMemoryAddress << endl;
    ...
    default:
    {
        ...
        while(true)
        {
            ...
            string tempBuff;
            int newLength = 0;
            tempBuff.append(buffStr, 0, kSize - 1);
